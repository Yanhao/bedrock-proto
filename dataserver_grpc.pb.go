...
type DataServiceClient interface {
	...
	DeleteShard(ctx context.Context, in *DeleteShardRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *dataServiceClient) DeleteShard(ctx context.Context, in *DeleteShardRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type DataServiceServer interface {
	...
	DeleteShard(context.Context, *DeleteShardRequest) (*empty.Empty, error)
...
func (UnimplementedDataServiceServer) DeleteShard(context.Context, *DeleteShardRequest) (*empty.Empty, error) {
