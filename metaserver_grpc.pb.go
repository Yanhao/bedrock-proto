...
func (c *metaServiceClient) HeartBeat(ctx context.Context, in *HeartBeatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedMetaServiceServer) HeartBeat(context.Context, *HeartBeatRequest) (*empty.Empty, error) {
